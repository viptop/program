        ...
        <section class="content">
                <div class="block">
                    ...
                    <div class="shop_title" shop_id="6860">
                        ...
                        <div class="fl"><span class="shopLink eclipse" href="">选择地址</span></div>
                            <!-- <a class="fl right_arrow" href=""></a> -->
                    </div>

                    <div class="cart_item" id="1100604422" item_id="" stock="195">
                        <input type="radio" name="items" value="" class="fl c_checkbox"/> 
                        <div class="detail">
                            <!-- <p class="fr prd_price">￥69.00</p> -->
                            <p class="fl prd_tit"><a href="/homes/modifyt/<?php echo $h.$val->id ?>" >  </a></p>
                            <p class="clear tags">
