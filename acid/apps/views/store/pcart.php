...
<header class="header" style="">
    ...
    <div class="h_label" style="color:#464646;">我的收货地址</div>
    <nav class="t-nav"></nav>
        ...
        <section class="content">
                <div class="block">
                    ...
                    <div class="shop_title" shop_id="6860">
                        ...
                        <div class="fl"><span class="shopLink eclipse" href="">收货地址</span></div>
                            <!-- <a class="fl right_arrow" href=""></a> -->
                    </div>

                <?php  foreach ($pdtor as $val) { ?>
                    <div class="cart_item" id="1100604422" item_id="<?php if($pdtor) echo $val->id ?>" stock="195">
                        <!-- <input type="radio" name="items" value="<?php if($pdtor) echo $val->id ?>" class="fl c_checkbox"/>  -->
                        <div class="detail">
                            <!-- <p class="fr prd_price">￥69.00</p> -->
                            <p class="fl prd_tit" style="padding-left:5%;"><a href="/homes/modifyt/<?php echo $h.$val->id ?>" ><?php echo $val->adds ?></a></p>
                            <p class="clear tags">
