function getDatabase() {
     return openDatabase("huihuisignin", "1.0", "dakasign", 1024*1024);
}
...
function createDb(dataBase,sql) {
  dataBase.transaction( function(tx) { 
    tx.executeSql(
    sql, 
    [], 
    function(tx,result){ return result; }, 
    function(tx, error){ return error.message; 
    });
  });
}


function insertDb (dataBase,sql,data) {
  dataBase.transaction(function (tx) {
    tx.executeSql(
    sql,
    data,
