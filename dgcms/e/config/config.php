...
$ecms_config['db']['dbtbpre']='dg_';	//数据表前缀
...
//后台安全设置
$ecms_config['esafe']['loginauth']='adminadmin';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='nB9kUNIQzZgsq39skD0GpPn9S0aEO0';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='cjyjv';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='vveki';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='HtvwTFDvjtzTF9W8FGgqYOxvvy0NEi';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='oh9OfzXqCM2uSYXlt48bUF6E7zRwxM';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'jp2VexLYjSESGifKBaJ51o8cGtwn8S',
